...
!-------------------------------------------------------------------------!
*/
package discourje.examples.tacas2020.npb3.ISThreads;
import discourje.examples.tacas2020.Benchmarks;
import discourje.examples.tacas2020.npb3.*;
...
/************************************/
  ...
  public void setupThreads(IS is){
    ...
    var m = Benchmarks.newMonitorOrNull(
            "discourje.examples.tacas2020.npb3.ISThreads.spec", "s", num_threads);
    ...
    for(int i=0;i<num_threads;i++){
      ...
      rankthreads[i]= new RankThread(is,i,start,end,rstart,rend,
              Benchmarks.newChan(1, "master", "worker[" + i + "]", m),
              Benchmarks.newChan(1, "worker[" + i + "]", "master", m));
      rankthreads[i].start();
    }
    for(int i=0;i<num_threads;i++){
